...
<main class="container">
    ...
    <section class="lots">
        ...
        <ul class="lots__list">
			...
			<?php $lots=[["title"=>"2014 Rossignol District Snowboard", "category"=>"Доски и лыжи", "price"=>"10999", "picture_URL"=>"img/lot-1.jpg"],
                         ["title"=>"DC Ply Mens 2016/2017 Snowboard", "category"=>"Доски и лыжи", "price"=>"159999", "picture_URL"=>"img/lot-2.jpg"],
						 ["title"=>"Крепления Union Contact Pro 2015 года размер L/XL", "category"=>"Крепления", "price"=>"8000", "picture_URL"=>"img/lot-3.jpg"],
