      ...
      <div class="lot-item__content">
        ...
        <div class="lot-item__right">
          <div class="lot-item__state">
            <div class="lot-item__timer timer <?php if($hour == 0): ?>timer--finishing<?php endif ?>">
              <?= time_remain($lot["date_finish"]); ?>
            </div>
...
<nav class="nav">
		...
		<?php foreach ($category as $value): ?>			
            <li class="nav__item">
                <a href="pages/all-lots.html"><?= $value['name_cat']; ?></a>
            </li>
		<?php endforeach; ?>
        </ul>
    </nav>
